...
print("********Top MNB********")
joblib.dump(top_classifier, "../trained/tfidf_TOP_MNB_sentiment_trained.joblib")
...
write_to_performance_file(PERFORMANCE_FILE_PATH, "Top-" + MNB, CLASSIFIER_SENTIMENT, confusion_matrix, cl_report, top_classifier.best_params_)
...
grid_search = GridSearchCV(classifier, parameters, scoring='f1_weighted')
top_classifier = grid_search.fit(X_train, y_train)
joblib.dump(top_classifier, "../trained/tfidf_TOP_MNB_emotion_trained.joblib")
...
write_to_performance_file(PERFORMANCE_FILE_PATH, "Top-" + MNB, CLASSIFIER_EMOTION, confusion_matrix, cl_report, top_classifier.best_params_)
