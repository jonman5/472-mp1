...
pretrained_model_name = "glove-twitter-100"
...
joblib.dump(MLP_emotions_model, "../Exploration_1_MLP_emotions_trained.joblib")
...
joblib.dump(MLP_sentiments_model, "../Exploration_1_MLP_sentiments_trained.joblib")
...
write_to_performance_file("../performance.txt", "Multi Layer Perceptron using " + pretrained_model_name + pretrained_model_name, "sentiment", confusion_matrix, cl_report, MLP_sentiments_model.get_params())
